	...
	LED_Reg_Write(0x00);
		...
		//LED_Reg_Write(0x01);
		  ...
		  response_data[1]=0x40;
                 ...
                 PORTD=PORTD^32; ///If this line is not used the old data initialised before while loop is being sent 
...
ISR(TIMER1_COMPA_vect){ //Checks argument
   ...
   PORTD=PORTD^32;///led is turned off and on once.  
}
